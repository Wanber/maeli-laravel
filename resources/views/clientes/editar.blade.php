...
@section('main_container')
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Editar Cliente - {{$cliente->nome}}
                ...
                <div class="x_content">
                    ...
                    <div class="item form-group {!! $errors->has('nome') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('nome', old('nome', $cliente->nome), [
                                'id' => 'nome',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('cpf') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('cpf', old('cpf', $cliente->cpf), [
                                'id' => 'cpf',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('rg') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('rg', old('rg', $cliente->rg), [
                                'id' => 'rg',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('dt_nascimento') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('dt_nascimento', old('dt_nascimento', $cliente->dt_nascimento('d/m/Y')), [
                                'id' => 'dt_nascimento',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('email') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::email('email', old('email', $cliente->email), [
                                'id' => 'email',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('telefone') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('telefone', old('telefone', $cliente->telefones->get(0)->numero()), [
                                'id' => 'telefone',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('telefone2') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('telefone2', old('telefone2', $cliente->telefones->get(1) ?  $cliente->telefones->get(1)->numero() : ''), [
                                'id' => 'telefone2',
                                'data-inputmask' => "'mask': '(99)9999[9]-9999', 'greedy': 'false'",
                                'placeholder' => 'Informe um telefone',
                                'class' => 'form-control col-md-7 col-xs-12'
                    ...
                    <div class="item form-group {!! $errors->has('sexo') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            <div class="radio">
                                ...
                                <label>
                                    {!! Form::radio('sexo', 'm', old('sexo', $cliente->sexo) == 'm' ? true : false, ['class' => 'flat']) !!}
                                    Masculino
                                </label>
                                <label>
                                    {!! Form::radio('sexo', 'f', old('sexo', $cliente->sexo) == 'f' ? true : false, ['class' => 'flat']) !!}
                                    Feminino
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="item form-group {!! $errors->has('estado_civil') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            <div class="radio">
                                ...
                                <label>
                                    {!! Form::radio('estado_civil', 'solteiro', old('estado_civil', $cliente->estado_civil) == 'solteiro' ? true : false, ['class' => 'flat']) !!}
                                    Solteiro
                                </label>
                                <label>
                                    {!! Form::radio('estado_civil', 'casado', old('estado_civil', $cliente->estado_civil) == 'casado' ? true : false, ['class' => 'flat']) !!}
                                    Casado
                                </label>
                                <label>
                                    {!! Form::radio('estado_civil', 'divorciado', old('estado_civil', $cliente->estado_civil) == 'divorciado' ? true : false, ['class' => 'flat']) !!}
                                    Divorciado
                                </label>
                                <label>
                                    {!! Form::radio('estado_civil', 'viuvo', old('estado_civil', $cliente->estado_civil) == 'viuvo' ? true : false, ['class' => 'flat']) !!}
                                    Viuvo
                                </label>
                                <label>
                                    {!! Form::radio('estado_civil', 'separado', old('estado_civil', $cliente->estado_civil) == 'separado' ? true : false, ['class' => 'flat']) !!}
                                    Separado
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="item form-group {!! $errors->has('cep') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 ">
                            {{Form::text('cep', old('cep', $cliente->cep()), [
                                'id' => 'cep',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('cidade') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('cidade', old('cidade', $cliente->cidade), [
                                'id' => 'cidade',
                                'required' => 'required',
                                'readonly',
                    ...
                    <div class="item form-group {!! $errors->has('bairro') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('bairro', old('bairro', $cliente->bairro), [
                                'id' => 'bairro',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('rua') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('rua', old('rua', $cliente->rua), [
                                'id' => 'rua',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('numero') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('numero', old('numero', $cliente->numero), [
                                'id' => 'numero',
                                'required' => 'required',
                    ...
                    <div class="item form-group {!! $errors->has('complemento') ? 'has-error' : '' !!}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                            {{Form::text('complemento', old('complemento', $cliente->complemento), [
                                'id' => 'complemento',
